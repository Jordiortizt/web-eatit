                ...
                <div class="sub-carta col-12 col-lg-6 py-5 mt-5">
                    ...
                    <form action="" onsubmit="return false;">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="ciutat" value="<?php echo $usuari->Ciudad ?>" placeholder="No hi ha ciutat registrada">
                        <div id="errorCiutat" class="form-text text-danger"></div>
                      </div>

...
<html lang="es">
  <head>
    ...
    <script src="./js/comandes-propietari.js"></script>
  ...
  <body>
    ...
    <header>
      ...
      <nav class="menu">
        ...
        <a href="./index-propietari.php" class="menu-item"> <i class="fas fa-home"></i> </a>
        <p class="sr-only">Espai</p>
        <p class="sr-only">Espai</p>
        <p class="sr-only">Espai</p>
        <a href="./index-propietari.php" class="menu-item"> <i class="fas fa-angle-left"></i> </a>
